    ...
    <aside className="w-[320px] h-screen sticky top-0 overflow-y-auto border-l border-[#2a2a2f] bg-[#0a0a0c] flex-shrink-0 hidden xl:block">
      ...
      {chatOpen && (
        <div className="h-full flex flex-col">
          <AiraChat onClose={() => setChatOpen(false)} />
        </div>
      )}
          ...
          <div className="bg-[#16181c] border border-[#2a2a2f] rounded-xl p-4 mb-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-2 bg-[#FF6B00] text-white rounded-lg text-xs font-semibold hover:bg-[#FF8533] transition-colors cursor-pointer"
              >
                💬 Ask a Question
              </button>
              <button className="flex-1 py-2 bg-[#1e2024] text-white border border-[#2a2a2f] rounded-lg text-xs font-semibold hover:bg-[#252830] transition-colors cursor-pointer">
                📄 Scan Document
              </button>
            </div>
